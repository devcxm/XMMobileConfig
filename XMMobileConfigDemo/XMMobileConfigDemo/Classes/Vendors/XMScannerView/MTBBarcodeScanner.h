...
@protocol XMScannerDelegate <NSObject>

- (CGRect)rectOfInterestInCapture;
 ...
 *  @param rect 范围
 */
- (void)setCaptureRectOfInterest:(CGRect)rect;

@property (nonatomic, strong) AVCaptureMetadataOutput *captureOutput;


@property (nonatomic, assign) id<XMScannerDelegate> xmScannerDelegate;
